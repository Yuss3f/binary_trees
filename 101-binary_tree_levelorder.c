...
/**
 * free_queue - Freeing a levelorder_queue_t queue.
...
/**
 * pint_push - Running a function on a given binary tree node and
...
/**
 * binary_tree_levelorder - Traversing a binary tree using
